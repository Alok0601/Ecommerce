...
struct Record: Codable {
    ...
    let listPrice, minimumListPrice, maximumListPrice, promoPrice: Double?
    let minimumPromoPrice, maximumPromoPrice: Double?
...
struct VariantsColor: Codable {
    let colorName, colorHex: String?
    let colorImageURL, colorMainURL: String?
    let skuId: String?
}
